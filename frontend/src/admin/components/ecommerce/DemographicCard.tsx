...
import { MdMoreVert } from "react-icons/md"; // More dots icon
import { FaFlagUsa, FaFlag } from "react-icons/fa"; // USA and France flags as placeholders
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="items-center w-full rounded-full max-w-8">
              <FaFlagUsa className="text-gray-500 dark:text-gray-400" />
            </div>
            <div>
