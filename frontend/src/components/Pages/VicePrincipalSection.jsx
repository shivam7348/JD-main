  ...
  return (
    <div className="flex flex-col md:flex-row items-center justify-center bg-gray-100 p-6">
      ...
      <div className="md:w-1/2 lg:w-1/2 p-4 text-center md:text-left">
        <h1 className="text-2xl sm:text-3xl font-bold text-gray-800 mb-3">J.D GLOBAL SCHOOL</h1>
        <h2 className="text-xl sm:text-2xl font-semibold text-gray-700 mb-3">Meet Our Vice Principal</h2>
        ...
        <p className="text-sm sm:text-base text-gray-600 font-semibold">Vice Principal</p>
